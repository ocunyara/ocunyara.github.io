...
!function (a) {
    ...
    a.extend(a.fn, {
        ...
        messages: {
            required: "Š•Ń‚Š¾ ŠæŠ¾Š»Šµ Š½ŠµŠ¾Š±Ń…Š¾Š´ŠøŠ¼Š¾ Š·Š°ŠæŠ¾Š»Š½ŠøŃ‚Ń.",
            remote: "Please fix this field.",
            email: "Please enter a valid email address.",
            url: "Please enter a valid URL.",
            date: "Š’Š²ŠµŠ´ŠøŃ‚Šµ ŠŗŠ¾Ń€ŠµŠŗŃ‚Š½ŃŃˇ Š´Š°Ń‚Ń.",
            dateISO: "Please enter a valid date ( ISO ).",
            number: "Please enter a valid number.",
            digits: "Š¯ŃŠ¶Š½Š¾ Š²Š²Š¾Š´ŠøŃ‚Ń Ń‚Š¾Š»ŃŠŗŠ¾ Ń†ŠøŃ„Ń€Ń‹",
        ...
        methods: {
            ...
            }, russian_letters: function (a, b) {
                return this.optional(b) || /^[Š°-Ń¸Š-ŠÆ ]*$/.test(a)
            },
            russian_letters_and_number: function (a, b) {
                return this.optional(b) || /^[Š°-Ń¸Š-ŠÆ0-9 ]*$/.test(a)
            },
            url: function (a, b) {
